OC.L10N.register(
    "files_mindmap",
    {
    "You cannot open a folder" : "Sa ei saa avada kausta",
    ...
    "You cannot write to a folder" : "Sa ei saa kausta kirjutada",
    "The file you are working on was updated in the meantime. You cannot save your progress as saving would overwrite these changes. Please reload the page." : "Fail, millega sa töötasid, on vahepeal muutunud. Kuna sa asendaksid need muudatused, siis sa ei saa oma tööd salvestada. Palun laadi leht uuesti.",
    ...
    "This application enables Nextcloud users to open, save and edit mind map files in the web browser. If enabled, an entry in the \"New\" button at the top of the web browser the mind map file entry appears. When clicked, a new mind map file opens in the browser and the file can be saved into the current Nextcloud folder." : "See rakendus võimaldab Nextcloudi kasutajatel veebibrauseris avada, salvestada ja muuta mõttekaardi faile. Kui rakendus on kasutusele võetud, siis lisandub kasutajaliidesesse vastav valik „Uue faili“ nupust avanevasse menüüsse. Sellel klõpsides avaneb veebibrauseris uus mõttekaardi fail, mida saad salvestada Nextcloudi kausta, kus hetkel asud.",
    "Does not support saving {extension} files." : "{extension} failide salvestamise tugi puudub.",
    "File Saved" : "Fail on salvestatud",
    "Save failed" : "Salvestamine ei õnnestunud",
    ...
    "Save" : "Salvesta",
    "Export" : "Ekspordi",
    "Export to PNG" : "Ekspordi png-failina",
