OC.L10N.register(
    ...
    "You are not permission to write this file" : "Sul puuduvad õigused valitud faili salvestamiseks",
    "Mind Map" : "Mõttekaart",
    "A Mind map editor" : "Mõttekaartide koostaja",
    "This application enables Nextcloud users to open, save and edit mind map files in the web browser. If enabled, an entry in the New button at the top of the web browser the Mindmap file entry appears. When clicked, a new mindmap file opens in the browser and the file can be saved into the current Nextcloud directory." : "See rakendus võimaldab Nextcloudi kasutajatel veebibrauseris avada, salvestada ja muuta mõttekaardi faile. Kui rakendus on kasutusele võetud, siis lisandub kasutajaliidesesse vastav valik „Uue faili“ nupust avanevasse menüüsse. Sellele klikates avaneb uus mõttekaardi fail, mida saad salvestada kausta, kus hetkel asud.",
