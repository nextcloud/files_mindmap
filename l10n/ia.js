OC.L10N.register(
    ...
    "Save" : "Salveguardar",
    "Export" : "Exportar",
    "Saved as {name}" : "Salveguardate como {name}",
    "\"{name}\" was created — your changes are saved there. The original .mm file is unchanged." : "\"{name}\" esseva create — vostre modificationes es salveguardate la. Le file .mm original es incambiate.",
