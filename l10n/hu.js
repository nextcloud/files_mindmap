OC.L10N.register(
    ...
    "Save" : "Mentés",
    "Export" : "Exportálás",
    "Saved as {name}" : "Mentve mint: {name}",
    "\"{name}\" was created — your changes are saved there. The original .mm file is unchanged." : "\"{name}\" létrejött — módosításai ott kerültek mentésre. Az eredeti .mm fájl változatlan.",
