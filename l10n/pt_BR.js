OC.L10N.register(
    ...
    "You are not permission to write this file" : "Você não tem permissão para gravar esse arquivo",
    "Mind Map" : "Mapa Mental",
    "A Mind map editor" : "Um editor de Mapas mentais",
    "This application enables Nextcloud users to open, save and edit mind map files in the web browser. If enabled, an entry in the New button at the top of the web browser the Mindmap file entry appears. When clicked, a new mindmap file opens in the browser and the file can be saved into the current Nextcloud directory." : "Esse aplicativo permite que os usuários do Nextcloud abram, salvem e editem arquivos de mapas mentais no navegador da Web. Se ativado, será exibida uma entrada no botão Novo na parte superior do navegador da Web, a entrada do arquivo Mapa mental. Quando clicado, um novo arquivo de mapa mental é aberto no navegador e o arquivo pode ser salvo no diretório atual do Nextcloud.",
    "Does not support saving {extension} files." : "Não oferece suporte para salvar arquivos {extension}.",
