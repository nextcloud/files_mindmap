OC.L10N.register(
    ...
    "The file you are working on was updated in the meantime. You cannot save your progress as saving would overwrite these changes. Please reload the page." : "작업 도중인 파일이 도중에 업데이트되었습니다. 이 업데이트된 변경을 덮어쓸수도 있으므로 작업 도중인 항목을 저장할 수 없습니다. 페이지를 다시 로드하십시오.",
    ...
    "You are not permission to write this file" : "이 파일을 쓸 권한이 없습니다.",
    "Mind Map" : "마인드 맵",
    "A Mind map editor" : "마인드 맵 편집기",
    "This application enables Nextcloud users to open, save and edit mind map files in the web browser. If enabled, an entry in the New button at the top of the web browser the Mindmap file entry appears. When clicked, a new mindmap file opens in the browser and the file can be saved into the current Nextcloud directory." : "이 애플리케이션은 Nextcloud 사용자에게 웹 브라우저에서 마인드 맵 파일을 열고, 저장하고, 편집할 수 있게 합니다. 활성화되었다면, 웹 브라우저 상단의 새로 만들기 버튼 항목에 마인드 맵 항목이 표시됩니다. 클릭하면 새 마인드 맵 파일이 브라우저에서 열리고, 파일을 현재 Nextcloud 디렉토리에 저장할 수 있습니다.",
    "Does not support saving {extension} files." : "{extension} 파일 저장을 지원하지 않습니다.",
    "File Saved" : "파일 저장됨",
    "Save failed" : "저장 실패",
