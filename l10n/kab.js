OC.L10N.register(
    ...
    "Save" : "Sekles",
    "Export" : "Sifeḍ",
    "Saved as {name}" : "Yermes s yisem {name}",
    "\"{name}\" was created — your changes are saved there. The original .mm file is unchanged." : "\"{name}\" yettwarna — leḥsab-ik/im yettwekkes dinna. Afaylu .mm anasli ur yettwabeddel ara.",
