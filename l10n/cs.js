OC.L10N.register(
    ...
    "This application enables Nextcloud users to open, save and edit mind map files in the web browser. If enabled, an entry in the New button at the top of the web browser the Mindmap file entry appears. When clicked, a new mindmap file opens in the browser and the file can be saved into the current Nextcloud directory." : "Tato aplikace umožňuje uživatelům Nextcloud otevírat, ukládat a upravovat myšlenkové mapy ve webovém prohlížeči. Když je zapnutá, objeví se v nabídce Nový položka Myšlenková mapa. Po kliknutí na ní se v prohlížeči otevře nová myšlenková mapa a je možné ji uložit do stávající složky v Nextcloud.",
